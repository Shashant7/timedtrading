...
| 2026-09-04 | F11/F22 — rank stamping regression | #1420 | n/a (ledger infra) | prod D1 | UPDATE arm nulled rank/rr on first lifecycle update; now COALESCE-sticky. Backfilled 163 ranks + 159 rr from each row's own rank_trace_json; 0 NULL ranks since Jun 6. Restored 90d study: rank-win corr +0.05 — F22 stands, field now live for Packet D |
| 2026-09-04 | A — duplicate EXIT repair (operator-approved) | no PR (D1 surgery) | n/a | prod D1 2026-09-04 ~11:10 UTC | Deleted 7 phantom EXIT events (KO/CLS/CAT/OKE exact dupes; DE full-qty-ignoring-trim; XLB two superseded full exits). Per-trade drift for all six tickers now 0. Realized +$329.81 → 37,235.28; cash resynced to identity 121,170.66 (= 100k + realized − cost basis). Balance-column shift was attempted, found wrong (column is identity-resynced, not cumulative), and reverted — lesson recorded. Residual gap −187.37 = ~+9.8 event-value drift (TSM/CSX/SPHB/XLI/CVNA/DPZ/SNDK, different failure class) − 197.20 open-trade trims |
| 2026-09-04 | I (slice) — admission seam identity forms | #1422 | n/a (entry gate) | contract tests | checkPlayAdmission resolves path AND name; paused plays blocked through all 4 identity forms; missing identity observable, not silent. Full multi-surface seam + bypass tests still open |
| 2026-09-04 | Macro narrative synthesis (shadow) | #1421 | n/a (shadow field) | 2026-09-03 Waller sequence | Session-level story clustering + synthesis on the wire pulse; narrative_risk_tone/divergence shadow-only. Influence = future one-lever experiment |
