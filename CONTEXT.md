...
- **ETHUSD July TD/phase/233 movie is rare (2026-08-21)**: over 316 tracked names, official Phase Leaving on M+W+D+4H never stacked (ETH monthly Saty osc only reached −33). Closest HTF TD13→9 + four-TF washout turn-up + 4H+ 233: ETHUSD and SRAD. Scan: `scripts/scan-eth-td-phase-233.mjs`.
