...
> **Incoming design refresh — Verda (2026-06-09).** The operator licensed
> the **Verda Finance** design system as the basis for a full UI refresh.
> The audited bundle lives at [`design/verda/`](design/verda/README.md)
> (spec, `system.css`, preview pages). **This file remains the normative
> spec for everything currently shipped** — pages are still built on
> `tt-tokens.css`. Migration happens page-by-page per
