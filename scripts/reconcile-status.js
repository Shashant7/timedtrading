...
/**
 * Fix status for closed trades where status disagrees with pnl (e.g. LOSS with positive P&L).
 *
 * Usage:
 *   TIMED_API_KEY=your_key node scripts/reconcile-status.js
 *   TIMED_API_KEY=your_key node scripts/reconcile-status.js --dry-run
 */
