 ...
 *
 * Only agreement used to be recorded, so BTC/ETH/SPY/QQQ — the one market-wide
 * input this detector has — could add conviction but never remove it. The
 * ticker's own 34/50 clouds have always scored both ways (+1 / -1); the tape
 * read now does too.
 *
