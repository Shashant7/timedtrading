    ...
    accounts: [
      {
        ...
        items: [
          ...
          { ticker: "PANW", managed: true, model_status: "OPEN", sync_state: "mothership_orphan", broker_qty: 0, avg_cost: null, price: 172.4, prev_close: 171.0, day_change: 1.4, day_change_pct: 0.82, model_open: true, auto_sync: true, sync_note: "model_open expected 1.00754 but broker holds 0" },
      ...
      },
      {
        ...
        items: [{ ticker: "IONQ", managed: false, model_open: true, model_stage: "accumulate", sync_state: "not_synced", broker_qty: 0, avg_cost: null, auto_sync: true, price: 43.68 }],
      },
    ],
  },
};
