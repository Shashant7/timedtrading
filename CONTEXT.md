...
- **Investor LT entries need LTF stabilization (2026-08-04)**: July autopsy (NBIS/AMD/IESC/MU) — HTF score alone opened into bearish 10m ST / no 5-12 curl / opposing FVG. Gate: `investorLtfEntryStabilizationBlock` on auto-rebalance admit; toggle `deep_audit_investor_ltf_entry_gate_enabled`.
