...
Structural vintage bumped to **2026-06-11** (June Sector Allocation): Healthcare overweight (+4.4% model weight to 9.5%), Utilities enters at 3.8%, Real Estate overweight, Tech/Industrials/Energy/Discretionary neutralized, Staples cut to 0.7%. Tactical overlay (6/11): defensive rotation — favor Healthcare/Utilities/REITs; caution Tech + Industrials; theme sleeve adds CIBR/IHF/ARKG/IYT. `/timed/strategy` now surfaces the live CRO KV override when active (`tactical.override_applied`).
