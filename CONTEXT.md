...
- **Broker Connections SHORT≠BUY + options holdings (2026-09-03):** ENTRY labels must read `direction` (SHORT open ≠ BUY). `/bridge/positions` must merge `getOptionsPositions` or SPY-class calls vanish from holdings. Never label Mirror-off accounts "NOT MIRRORED".
