...
(function () {
  ...
  (function ensureRailShare() {
    try {
      ...
      s.src = "shared-rail-share.js?v=20260624a";
      s.async = true;
  ...
  const Component = window.TickerDetailRightRailFactory({
    ...
    phaseToColor:            TT.phaseToColor            || (() => "#8AA39A"),
    ...
    getDirection:             RH.getDirection             || (() => ({ text: "—", color: "text-[#6E867D]", bg: "bg-white/[0.04]" })),
    getActionDescription:     RH.getActionDescription     || (() => ({ action: "Monitor", description: "", color: "text-[#6E867D]", bg: "bg-white/[0.04]" })),
