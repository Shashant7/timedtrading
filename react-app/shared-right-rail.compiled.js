  ...
  window.TickerDetailRightRailFactory = function (deps) {
    ...
    return function TickerDetailRightRail({
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "sticky top-0 z-30 bg-[#0b0e11] border-b border-white/[0.04] px-6 py-4"
      }, /*#__PURE__*/React.createElement("div", {
        className: "flex items-center justify-between"
      }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
        className: "text-xl font-bold"
      }, tickerSymbol), ticker.price && /*#__PURE__*/React.createElement("div", {
        className: "text-sm text-white mt-1 flex items-center gap-1.5"
      }, /*#__PURE__*/React.createElement("span", null, "$", Number(ticker.price).toFixed(2)), (() => {
        ...
        if (freshestAge <= 2) return /*#__PURE__*/React.createElement("span", {
          ...
          title: `Price updated ${Math.round(freshestAge)}m ago`
        });
        ...
        try {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            return /*#__PURE__*/React.createElement("span", {
              key: `group-${g}`,
              className: `text-[9px] px-1.5 py-0.5 rounded border ${isSocial ? "bg-purple-500/15 border-purple-500/40 text-purple-200" : "bg-white/[0.02] border-white/[0.06] text-[#f0f2f5]"}`
            }, label);
          }));
        } catch {
          return null;
        ...
        }, !suppressMove && status ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
          className: "text-[#6b7280]"
        }, "Move:"), /*#__PURE__*/React.createElement("span", {
          className: `px-2 py-0.5 rounded border font-semibold ${pill}`
        }, icon, " ", status, severity && severity !== "NONE" ? /*#__PURE__*/React.createElement("span", {
          className: "ml-1 text-[10px] opacity-80"
        }, "(", severity, ")") : null)) : null, kanbanStage ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
          className: "text-[#6b7280]"
        }, suppressMove ? "Stage:" : "Action:"), /*#__PURE__*/React.createElement("span", {
          className: `px-2 py-0.5 rounded border font-semibold ${kanbanPill}`
        }, stageLabel)) : null), /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("button", {
          ...
          className: `px-3 py-1 rounded-lg border text-[11px] font-semibold transition-all ${active ? "border-blue-400 bg-blue-500/20 text-blue-200" : "border-white/[0.06] bg-white/[0.03] text-[#6b7280] hover:text-white"}`
        }, t.label);
      }))), /*#__PURE__*/React.createElement("div", {
        className: "p-6 pt-4"
        ...
        return /*#__PURE__*/React.createElement("div", {
          className: "mb-3 p-3 rounded-xl border border-white/[0.06] bg-white/[0.02]"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-[#6b7280] font-semibold mb-2 uppercase tracking-wider"
        }, "Risk / Reward Levels"), hasSl && /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-2 mb-2 text-xs"
        }, /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-1.5 px-2 py-1 rounded-lg bg-red-500/10 border border-red-500/25"
        }, /*#__PURE__*/React.createElement("span", {
          ...
          className: "space-y-1.5"
        }, has3Tier ? /*#__PURE__*/React.createElement(React.Fragment, null, Number.isFinite(tpTrim) && tpTrim > 0 && /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between gap-2 text-xs"
        }, /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-1.5 px-2 py-1 rounded-lg bg-yellow-500/10 border border-yellow-500/25"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] text-yellow-300"
        }, "TP1"), /*#__PURE__*/React.createElement("span", {
          className: "font-bold text-yellow-400"
        }, "$", tpTrim.toFixed(2)), /*#__PURE__*/React.createElement("span", {
          className: "text-[9px] text-yellow-300/70"
        }, "Trim 60%")), /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-2"
        }, Number.isFinite(tpPct(tpTrim)) && /*#__PURE__*/React.createElement("span", {
          className: "text-[9px] text-[#6b7280]"
        }, tpPct(tpTrim).toFixed(1), "%"), Number.isFinite(rrTrim) && /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] font-semibold text-blue-400"
        }, rrTrim.toFixed(2), ":1"))), Number.isFinite(tpExit) && tpExit > 0 && /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between gap-2 text-xs"
        }, /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-1.5 px-2 py-1 rounded-lg bg-orange-500/10 border border-orange-500/25"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] text-orange-300"
        }, "TP2"), /*#__PURE__*/React.createElement("span", {
          className: "font-bold text-orange-400"
        }, "$", tpExit.toFixed(2)), /*#__PURE__*/React.createElement("span", {
          className: "text-[9px] text-orange-300/70"
        }, "Exit 85%")), /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-2"
        }, Number.isFinite(tpPct(tpExit)) && /*#__PURE__*/React.createElement("span", {
          className: "text-[9px] text-[#6b7280]"
        }, tpPct(tpExit).toFixed(1), "%"), Number.isFinite(rrExit) && /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] font-semibold text-blue-400"
        }, rrExit.toFixed(2), ":1"))), Number.isFinite(tpRunner) && tpRunner > 0 && /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between gap-2 text-xs"
        }, /*#__PURE__*/React.createElement("div", {
        ...
        }, "TP3"), /*#__PURE__*/React.createElement("span", {
          className: "font-bold text-teal-400"
        }, "$", tpRunner.toFixed(2)), /*#__PURE__*/React.createElement("span", {
          className: "text-[9px] text-teal-300/70"
        }, "Runner")), /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-2"
        }, Number.isFinite(tpPct(tpRunner)) && /*#__PURE__*/React.createElement("span", {
          className: "text-[9px] text-[#6b7280]"
        }, tpPct(tpRunner).toFixed(1), "%"), Number.isFinite(rrRunner) && /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] font-semibold text-blue-400"
        }, rrRunner.toFixed(2), ":1")))) : hasLegacy ? /*#__PURE__*/React.createElement(React.Fragment, null, Number.isFinite(legacyTarget) && /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between gap-2 text-xs"
        }, /*#__PURE__*/React.createElement("div", {
          className: "flex items-center gap-1.5 px-2 py-1 rounded-lg bg-teal-500/10 border border-teal-500/25"
        }, /*#__PURE__*/React.createElement("span", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-xs text-[#6b7280] font-semibold"
        }, "\uD83D\uDE80 Momentum Elite"), /*#__PURE__*/React.createElement("span", {
        ...
        if (tpArray.length === 0) {
          ...
          if (Number.isFinite(tpTrim) && tpTrim > 0) {
            tpArray = [{
              ...
              trimPct: 0.60,
              tier: "TRIM",
              label: "TRIM (60%) @ 61.8% ATR"
            }, ...(Number.isFinite(tpExit) && tpExit > 0 ? [{
              price: tpExit,
              trimPct: 0.85,
              tier: "EXIT",
              label: "EXIT (85%) @ 100% ATR"
            }] : []), ...(Number.isFinite(tpRunner) && tpRunner > 0 ? [{
              price: tpRunner,
              trimPct: 0.95,
              tier: "RUNNER",
              label: "RUNNER (95%) @ 161.8% ATR"
            }] : [])];
          }
        }
        ...
        if (has3TierSystem && tpArray.length > 0) {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            return /*#__PURE__*/React.createElement("div", {
              ...
              className: "flex justify-between text-[10px] text-[#6b7280] mt-0.5"
        ...
        try {
          ...
          if (chartOverlays.supertrend && n >= 11) {
            ...
            const stUpArr = new Array(n).fill(null),
              stDnArr = new Array(n).fill(null),
              stDirArr = new Array(n).fill(1);
            superTrendData = new Array(n).fill(null);
            for (let i = stP; i < n; i++) {
              if (!atrArr[i]) continue;
              const hl2 = (highsForST[i] + lowsForST[i]) / 2;
              let up = hl2 - stM * atrArr[i],
                dn = hl2 + stM * atrArr[i];
              ...
              stUpArr[i] = up;
              stDnArr[i] = dn;
              if (i === stP) stDirArr[i] = closesForEma[i] > dn ? 1 : -1;else {
                stDirArr[i] = stDirArr[i - 1] === 1 && closesForEma[i] < stUpArr[i] ? -1 : stDirArr[i - 1] === -1 && closesForEma[i] > stDnArr[i] ? 1 : stDirArr[i - 1];
              }
              superTrendData[i] = {
                val: stDirArr[i] === 1 ? stUpArr[i] : stDnArr[i],
                dir: stDirArr[i]
              };
            }
          }
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            label: "TD Seq",
            color: "#f59e0b"
          }].map(ov => /*#__PURE__*/React.createElement("button", {
            key: ov.key,
            onClick: () => setChartOverlays(prev => ({
              ...prev,
              [ov.key]: !prev[ov.key]
            })),
            className: `px-2 py-0.5 rounded text-[9px] font-semibold border transition-all ${chartOverlays[ov.key] ? "border-white/20 text-white" : "border-white/[0.06] text-[#555] hover:text-[#6b7280]"}`,
            style: chartOverlays[ov.key] ? {
              borderColor: ov.color + "80",
              color: ov.color,
              background: ov.color + "15"
            } : {}
          }, ov.label))), /*#__PURE__*/React.createElement("div", {
            ref: chartScrollRef,
          ...
          }), ema21Data.length > 0 && /*#__PURE__*/React.createElement("path", {
            d: buildEmaPath(ema21Data),
            fill: "none",
            stroke: "#fbbf24",
            strokeWidth: "1.3",
            strokeOpacity: "0.8"
          }), ema48Data.length > 0 && /*#__PURE__*/React.createElement("path", {
            d: buildEmaPath(ema48Data),
            fill: "none",
            stroke: "#a78bfa",
            strokeWidth: "1.3",
            strokeOpacity: "0.8"
          }), ema200Data.length > 0 && /*#__PURE__*/React.createElement("path", {
            d: buildEmaPath(ema200Data),
            fill: "none",
            stroke: "#f87171",
            strokeWidth: "1.3",
            strokeOpacity: "0.7"
            ...
            if (curSeg) segments.push(curSeg);
            return segments.map((seg, si) => /*#__PURE__*/React.createElement("path", {
              key: `st-${si}`,
              d: seg.d,
              fill: "none",
              stroke: seg.dir === 1 ? "#34d399" : "#f87171",
              strokeWidth: "1.5",
              strokeOpacity: "0.7"
            }));
            ...
            for (let i = PREP_COMP; i < n; i++) {
              ...
              if (bullPrep >= 7 || bearPrep >= 7) {
                ...
                tdLabels.push(/*#__PURE__*/React.createElement("text", {
                  key: `td-${i}`,
                  x: cx,
                  y: yPos,
                  textAnchor: "middle",
