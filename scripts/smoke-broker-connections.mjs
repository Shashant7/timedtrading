...
const CANNED = {
  ...
  "/timed/broker/day-actions": {
    ...
    actions: [
      ...
      { ts: NOW - 2 * 3600e3, mode: "trader", event: "ENTRY", ticker: "SPYU", qty: 56, price: 35.44, value: 1984.64, realized_pnl: 0, instrument: "letf", mirror: "skipped", mirror_reason: "daily_cap_3_reached", note: "compression_dip", fills: [], rejects: [] },
    ...
    summary: { actions: 5, mirrored: 2, rejected: 2, skipped: 1, not_mirrored: 0, realized_pnl: -270.1 },
...
const checks = [
  ...
  ["model actions count from 72h", />5</],
  ...
  ["index-trend skip reason humanized", /Shared auto-mirror daily cap reached/],
  ["index-trend SPYU timeline row", /SPYU/],
