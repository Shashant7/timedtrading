#!/usr/bin/env node
/**
 * Push July v5 config — beat anchor refinements on top of v4 index model.
 */
...
const UPDATES = [
  ...
  { key: "deep_audit_earnings_cluster_block_high_rank_members", value: "true" },
  ...
  // Anchor had XLY +0.81%; sector ETF pause blocked it in v4.
...
async function main() {
  console.log(`Pushing v5 config (${UPDATES.length} keys)...`);
