export const REPLAY_DA_KEYS = [
  ...
  // P0.7.180 / P0.7.181 / P0.7.182 / P0.7.183 (2026-05-15) — May 2026
  // performance audit. Same-day thesis-flip skip, raised early-trim PnL
  ...
  "deep_audit_earnings_cluster_block_high_rank_members",
  "deep_audit_earnings_cluster_high_rank_floor",
  "deep_audit_earnings_cluster_high_rank_day_pad",
  "deep_audit_index_model_reentry_cooldown_hours",
  "deep_audit_doctrine_force_defer_bull_enabled",
  "deep_audit_doctrine_force_defer_min_rank",
  "deep_audit_doctrine_force_defer_max_loss_pct",
  ...
  "deep_audit_forming_pair_floors",
  "deep_audit_forming_pair_conviction_floor",
  "deep_audit_forming_pair_hold_winners",
  "deep_audit_forming_pair_hard_floor_pct",
  "deep_audit_ja_htf_reclaim_max_ext_pct",
  "deep_audit_ja_htf_reclaim_conviction_floor",
  "deep_audit_ja_htf_reclaim_cooldown_hours",
  "deep_audit_ja_htf_reclaim_max_days_above",
  "deep_audit_ja_reclaim_daily_max",
  ...
  "deep_audit_conviction_sizing_enabled",           // 2026-08-20 — grade × stance × FSD × tape sizing multiplier
  "deep_audit_conviction_sizing_min",               // default 0.40
  "deep_audit_conviction_sizing_max",               // default 2.00
  ...
  // code — until the owner writes this row to model_config, ZERO live
  // behavior changes.
  //   {
  ...
  //     // Phase 5 R3 — chop-regime size haircut (default factor 0.5)
