...
export const SANITY_CHECK_PLAYBOOK = {
  ...
  bridge_mirror_coverage: {
    ...
    auto_heal: false,
    needs_pr: false,
    agent_prompt: "BROKER_INVESTOR_MIRROR_ENABLED but no bridge mirror calls. Check waitUntil scope, bridge forwarder, auto-rebalance cron.",
  },
  ...
  broker_bridge_bindings: {
    ...
    auto_heal: false,
    needs_pr: false,
    files_hint: ["worker/wrangler.toml", "worker-bridge/"],
    agent_prompt: "Bridge URL set but HMAC / service binding missing. Align wrangler bindings + secrets with worker-bridge deploy.",
  },
  worker_role_split: {
    kind: "infra",
    auto_heal: false,
