  ...
  read -r -d '' PAYLOAD <<'JSON' || true
{
  "updates": [
    ...
    {"key": "deep_audit_index_etf_swing_pct_above_e48_min", "value": "1.0"},
    {"key": "deep_audit_index_etf_swing_pct_above_e48_max", "value": "7.0"},
    {"key": "deep_audit_index_etf_swing_pct_below_e48_min", "value": "1.0"},
    {"key": "deep_audit_index_etf_swing_pct_below_e48_max", "value": "7.0"},
    {"key": "deep_audit_index_etf_swing_e21_slope_min", "value": "0.3"},
    {"key": "deep_audit_index_etf_swing_e21_slope_max", "value": "3.0"},
    {"key": "deep_audit_index_etf_swing_rvol_min", "value": "0.7"},
