...
function PatternsTab() {
  ...
  return React.createElement("div", null, React.createElement("div", {
  ...
  }, "Active Patterns"), React.createElement("label", {
    className: "flex items-center gap-2 text-[11px] text-slate-400 cursor-pointer"
  }, React.createElement("input", {
    type: "checkbox",
    checked: showAllPatterns,
    onChange: e => setShowAllPatterns(e.target.checked)
  }), "Show patterns with 0 samples")), !patterns ? React.createElement("p", {
    className: "text-slate-500 text-xs"
  }, "Loading...") : patterns.length === 0 ? React.createElement("p", {
    className: "text-slate-500 text-xs"
  }, "No active patterns.") : (() => {
    const visible = showAllPatterns ? patterns : patterns.filter(p => Number(p.sample_count || 0) >= 20);
    ...
    }, "Confidence"))), React.createElement("tbody", null, visible.map((p, i) => React.createElement("tr", {
      key: i,
    ...
    }, (Number(p.confidence) * 100).toFixed(0), "%")))))), hiddenCount > 0 && React.createElement("p", {
      className: "text-[10px] text-slate-500 mt-2"
    }, hiddenCount, " pattern", hiddenCount === 1 ? "" : "s", " hidden (less than 20 samples). Toggle \"Show patterns with 0 samples\" to see them."), visible.length === 0 && React.createElement("p", {
      className: "text-xs text-slate-500 py-3 text-center"
    }, "No patterns with \u226520 samples yet. Toggle the checkbox above to see all."));
  })()), sub === "predictions" && React.createElement("div", {
    className: "card p-5"
  }, React.createElement("h3", {
    className: "text-sm font-semibold text-white mb-3"
  ...
  }, marketRows.length || 0, " market snapshots")), marketRows.length === 0 && sectorRows.length === 0 && React.createElement("div", {
    className: "rounded-lg border border-amber-500/30 bg-amber-500/5 p-3 text-xs"
  }, React.createElement("div", {
    className: "text-amber-300 font-medium mb-1"
  }, "No context snapshots yet"), React.createElement("p", {
    className: "text-slate-400"
  }, "The ", React.createElement("code", {
    className: "text-slate-200 font-mono"
  }, "market_context_daily"), " table is empty. Backfill it locally with", " ", React.createElement("code", {
    className: "text-slate-200 font-mono"
  }, "USE_D1=1 node scripts/seed-market-context.js --backfill 90"), " ", "(90-day window). Once seeded, ticker-profile + regime mapping joins will pick up real historical breadth/regime/VIX context instead of falling back to reconstructed candles.")), marketRows.length > 0 && React.createElement("div", {
    className: "overflow-x-auto"
  }, React.createElement("table", {
    className: "w-full text-xs"
  }, React.createElement("thead", null, React.createElement("tr", {
...
function RunsTab({
  ...
  const [validationForm, setValidationForm] = useState({
    ...
    configRunId: "",
    takeOverLock: true,
    seedMarketEvents: true,
    disableReferenceExecution: true,
    skipInvestor: true,
    lowWrite: true,
    keepOpenAtEnd: false,
    tickers: "",
      ...
      if (liveRes?.ok) {
        ...
        setLiveSummary(liveRow ? {
          ...
          trades: liveRow.trades || {
            total: liveRow.total_trades,
            wins: liveRow.wins,
            losses: liveRow.losses,
            win_rate: liveRow.win_rate
          },
          pnl: liveRow.pnl || {
            realized: liveRow.realized_pnl,
            realized_pct: liveRow.realized_pnl_pct,
            avg_win_pct: liveRow.avg_win_pct,
            avg_loss_pct: liveRow.avg_loss_pct
          }
        } : null);
      }
  ...
  const updateValidationFormField = (field, value) => {
  ...
  const loadConfigOverrideFromRun = async runId => {
    ...
    if (!data?.config || Object.keys(data.config).length === 0) {
      throw new Error(`No archived config found for ${runId}`);
    }
    return data.config;
  };
  ...
  const startValidationRun = async () => {
    ...
    if (!validationForm.startDate || !validationForm.endDate) {
  ...
  const validationRunOptions = useMemo(() => {
    ...
    const add = run => {
      ...
      if (map.has(run.run_id)) return;
      map.set(run.run_id, {
        run_id: run.run_id,
        label: run.label || run.run_id,
        live: !!run.live_config_slot,
        protected: !!run.is_protected_baseline,
        status: run.status || "completed"
      });
    };
    add(liveSummary);
  ...
  useEffect(() => {
    if (!validationForm.configRunId && validationRunOptions.length > 0) {
      const preferred = validationRunOptions.find(run => run.live) || validationRunOptions.find(run => run.protected) || validationRunOptions[0];
      if (preferred?.run_id) {
        setValidationForm(prev => ({
          ...prev,
          configRunId: preferred.run_id
        }));
      }
    }
  }, [validationForm.configRunId, validationRunOptions]);
  ...
  return React.createElement("div", {
    ...
    type: "date",
    className: "w-full px-3 py-2 rounded-lg bg-slate-900/60 border border-white/10 text-slate-200",
    value: validationForm.startDate,
    onChange: e => updateValidationFormField("startDate", e.target.value)
  })), React.createElement("label", {
    className: "block"
  }, React.createElement("div", {
    className: "text-[10px] uppercase tracking-[0.08em] text-slate-500 mb-1"
    ...
    type: "date",
    className: "w-full px-3 py-2 rounded-lg bg-slate-900/60 border border-white/10 text-slate-200",
    value: validationForm.endDate,
    onChange: e => updateValidationFormField("endDate", e.target.value)
  })), React.createElement("label", {
    className: "block"
  }, React.createElement("div", {
    className: "text-[10px] uppercase tracking-[0.08em] text-slate-500 mb-1"
  }, "Interval Minutes"), React.createElement("input", {
    type: "number",
    min: "1",
    max: "30",
    className: "w-full px-3 py-2 rounded-lg bg-slate-900/60 border border-white/10 text-slate-200",
    ...
    onChange: e => updateValidationFormField("description", e.target.value)
  })), React.createElement("label", {
    className: "block"
  }, React.createElement("div", {
    className: "text-[10px] uppercase tracking-[0.08em] text-slate-500 mb-1"
  }, "Config Source"), React.createElement("select", {
    className: "w-full px-3 py-2 rounded-lg bg-slate-900/60 border border-white/10 text-slate-200",
    value: validationForm.configSource,
    onChange: e => updateValidationFormField("configSource", e.target.value)
  }, React.createElement("option", {
    value: "run"
  }, "Pinned config from an archived run"), React.createElement("option", {
    value: "live"
  }, "Use current live `model_config`"))), React.createElement("label", {
    className: "block"
  }, React.createElement("div", {
    className: "text-[10px] uppercase tracking-[0.08em] text-slate-500 mb-1"
  }, "Config Run"), React.createElement("select", {
    className: "w-full px-3 py-2 rounded-lg bg-slate-900/60 border border-white/10 text-slate-200",
    value: validationForm.configRunId,
    onChange: e => updateValidationFormField("configRunId", e.target.value),
    disabled: validationForm.configSource !== "run"
  }, React.createElement("option", {
    value: ""
  }, "Select run"), validationRunOptions.map(run => React.createElement("option", {
    key: run.run_id,
    value: run.run_id
    ...
    className: "w-full px-3 py-2 rounded-lg bg-slate-900/60 border border-white/10 text-slate-200 font-mono",
    value: validationForm.tickers,
    ...
    type: "checkbox",
    checked: validationForm.takeOverLock,
    onChange: e => updateValidationFormField("takeOverLock", e.target.checked),
    className: "rounded"
  }), "Take over existing replay lock"), React.createElement("label", {
    className: "runs-control cursor-pointer hover:text-slate-200 transition-colors"
  }, React.createElement("input", {
    type: "checkbox",
    checked: validationForm.seedMarketEvents,
    onChange: e => updateValidationFormField("seedMarketEvents", e.target.checked),
    className: "rounded"
  }), "Seed market events first"), React.createElement("label", {
    className: "runs-control cursor-pointer hover:text-slate-200 transition-colors"
  }, React.createElement("input", {
    type: "checkbox",
    checked: validationForm.disableReferenceExecution,
    onChange: e => updateValidationFormField("disableReferenceExecution", e.target.checked),
    className: "rounded"
  }), "Disable reference execution"), React.createElement("label", {
    className: "runs-control cursor-pointer hover:text-slate-200 transition-colors"
  }, React.createElement("input", {
    type: "checkbox",
    checked: validationForm.skipInvestor,
    onChange: e => updateValidationFormField("skipInvestor", e.target.checked),
    className: "rounded"
  }), "Trader-only replay"), React.createElement("label", {
    className: "runs-control cursor-pointer hover:text-slate-200 transition-colors"
  }, React.createElement("input", {
    type: "checkbox",
    checked: validationForm.lowWrite,
    onChange: e => updateValidationFormField("lowWrite", e.target.checked),
    className: "rounded"
  }), "Low write mode"), React.createElement("label", {
    className: "runs-control cursor-pointer hover:text-slate-200 transition-colors"
  }, React.createElement("input", {
    type: "checkbox",
      ...
      onClick: () => {
        ...
        Promise.all([fetch(`${API_BASE}/timed/admin/runs/detail?run_id=${encodeURIComponent(runId)}`, {
          ...
          if (liveRes?.ok && liveRun) {
            let snap = null;
            try {
              snap = JSON.parse(liveRun.snapshot_json || "null");
            } catch (_) {}
...
function MoveDiscoveryTab({
  ...
  const tipFor = k => ({
    total: "Every >2 ATR, ≥3-day move detected on the universe in the analysis window.",
    capture: "% of moves where we entered AND held — full + partial captures.",
    missed: "% of moves we never entered. Top blocker shown in Miss Buckets.",
    churn: "% of moves we entered but exited too early — see Churn tab for missed upside per ticker.",
    diag: "How many missed moves were diagnosed by the bucketing pipeline. 0 means the diagnosis script hasn't run since the last move-discovery refresh."
  })[k];
  return React.createElement("div", {
  ...
  }, "Where we left money on the table \u2014 and the next knob to tune.")), React.createElement("div", {
    style: {
      textAlign: "right"
    }
  }, React.createElement("div", {
    style: {
      fontSize: "var(--ds-fs-meta)",
      color: isStale ? "var(--ds-accent)" : "var(--ds-text-muted)"
    }
  }, report?.generated ? `Generated ${new Date(report.generated).toLocaleString()}` : "No generation time", isStale && React.createElement("span", {
    style: {
      marginLeft: 6,
      color: "var(--ds-accent)"
    }
    ...
    className: "si-kpi__label si-tip",
    "data-tip": tipFor("total")
  }, "Total moves"), React.createElement("div", {
    className: "si-kpi__value"
  }, summary.total_moves || 0), React.createElement("div", {
    className: "si-kpi__sub"
  }, summary.unique_tickers || 0, " tickers")), React.createElement("a", {
    className: "si-kpi",
    href: "trade-autopsy.html?status=WIN",
    title: tipFor("capture"),
    style: {
      textDecoration: "none"
    }
  }, React.createElement("div", {
    className: "si-kpi__label si-tip",
    "data-tip": tipFor("capture")
  }, "Capture rate"), React.createElement("div", {
    className: "si-kpi__value si-kpi__value--up"
  }, summary.capture_rate || 0, React.createElement("span", {
    className: "si-kpi__suffix"
  }, "%")), React.createElement("div", {
    className: "si-kpi__sub"
    ...
    className: "si-kpi__label si-tip",
    "data-tip": tipFor("missed")
  }, "Missed"), React.createElement("div", {
    className: "si-kpi__value si-kpi__value--dn"
  }, summary.missed_rate || 0, React.createElement("span", {
    className: "si-kpi__suffix"
  }, "%")), React.createElement("div", {
    className: "si-kpi__sub"
  }, summary.missed || 0, " moves")), React.createElement("a", {
    className: "si-kpi",
    href: "trade-autopsy.html?status=churn",
    title: tipFor("churn"),
    style: {
      textDecoration: "none"
    }
    ...
    className: "si-kpi__label si-tip",
    "data-tip": tipFor("churn")
  }, "Churned"), React.createElement("div", {
    className: "si-kpi__value si-kpi__value--accent"
  }, summary.churn_rate || 0, React.createElement("span", {
    className: "si-kpi__suffix"
  }, "%")), React.createElement("div", {
    className: "si-kpi__sub"
    ...
    className: "si-kpi__label si-tip",
    "data-tip": tipFor("diag")
  }, "Diagnosis coverage"), totalDiagnosed > 0 ? React.createElement(React.Fragment, null, React.createElement("div", {
    className: "si-kpi__value"
  }, totalDiagnosed), React.createElement("div", {
    className: "si-kpi__sub"
  }, diagnosis?.limit_applied ? `Limited to top ${diagnosis.limit_applied}` : "Full diagnosed set")) : React.createElement(React.Fragment, null, React.createElement("div", {
    className: "si-kpi__value si-kpi__value--accent",
    style: {
      fontSize: "18px"
    }
    ...
    const ctaLabel = totalDiagnosed === 0 ? "Run diagnosis" : noTrailPct > 50 ? "Open Trade Autopsy" : lowRankCount > wrongStateCount ? "Tune rank gate" : wrongStateCount > 0 ? "Tune state gates" : "Open analysis";
    const ctaHref = totalDiagnosed === 0 ? "#" : noTrailPct > 50 ? "trade-autopsy.html" : "?tab=analysis";
    return React.createElement("div", {
