  ...
  window.TickerDetailRightRailFactory = function (deps) {
    ...
    return function TickerDetailRightRail({
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "sticky top-0 z-30 bg-[#13171e] border-b border-[#252b36] px-6 py-4"
      }, /*#__PURE__*/React.createElement("div", {
        className: "flex items-center justify-between"
      }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("h3", {
        className: "text-xl font-bold"
      }, tickerSymbol), ticker.price && /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "ml-2 text-[10px] text-[#8b92a0]"
        }, "AH", stale?.ageLabel ? ` • as of ${stale.ageLabel}` : ""));
      })(), (() => {
        const stage = String(ticker?.kanban_stage || "");
        const showEntryStats = stage === "enter_now" || stage === "hold" || stage === "just_entered" || stage === "trim" || stage === "exit";
        ...
        const entryPx = Number.isFinite(entryPriceRaw) && entryPriceRaw > 0 ? entryPriceRaw : Number.isFinite(entryRefRaw) && entryRefRaw > 0 ? entryRefRaw : Number.isFinite(triggerRaw) && triggerRaw > 0 ? triggerRaw : null;
        const dir = getDirectionFromState(ticker);
        const entryPctRaw = numFromAny(ticker?.entry_change_pct);
        const entryPct = Number.isFinite(entryPctRaw) ? entryPctRaw : Number.isFinite(entryPx) && entryPx > 0 && Number.isFinite(price) && price > 0 ? dir === "SHORT" ? (entryPx - price) / entryPx * 100 : (price - entryPx) / entryPx * 100 : null;
        ...
        try {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            return /*#__PURE__*/React.createElement("span", {
              key: `group-${g}`,
              className: `text-[9px] px-1.5 py-0.5 rounded border ${isSocial ? "bg-purple-500/15 border-purple-500/40 text-purple-200" : "bg-[#13171e] border-[#252b36] text-[#f0f2f5]"}`
            }, label);
          }));
        } catch {
          return null;
        ...
        try {
          ...
          if (ageMinutes < 5) {
            ...
            ageColor = ageHours < 2 ? "text-yellow-400" : "text-orange-400";
          } else {
          ...
          }, "Last Ingest:"), /*#__PURE__*/React.createElement("span", {
            className: "text-white font-semibold"
          }, displayDate, " ", displayTime), /*#__PURE__*/React.createElement("span", {
            className: `font-semibold ${ageColor}`
          }, "(", ageText, ")"));
        } catch {
          return null;
        }
        ...
        const reasons = reasonsRaw.filter(x => x != null).map(x => String(x)).filter(x => x.trim()).slice(0, 8);
        const freshnessLabel = (() => {
          const isStale = !!staleInfo?.isStale;
          const age = staleInfo?.ageLabel ? ` (${staleInfo.ageLabel})` : "";
          return `${isStale ? "Stale" : "Fresh"}${age}`;
        })();
        const freshnessCls = staleInfo?.isStale ? "text-yellow-300" : "text-green-300";
        const headlineReason = reasons.length > 0 ? pretty(reasons[0]) : null;
        const kanbanStageRaw = String(ticker?.kanban_stage || "").trim();
        const kanbanStage = kanbanStageRaw ? kanbanStageRaw.toUpperCase() : "";
        const kanbanPill = kanbanStage === "EXIT" ? "bg-red-500/15 text-red-300 border-red-500/40" : kanbanStage === "TRIM" ? "bg-yellow-500/15 text-yellow-300 border-yellow-500/40" : kanbanStage === "DEFEND" ? "bg-orange-500/15 text-orange-300 border-orange-500/40" : kanbanStage === "HOLD" ? "bg-blue-500/15 text-blue-300 border-blue-500/40" : kanbanStage === "ENTER_NOW" ? "bg-green-500/15 text-green-300 border-green-500/40" : "bg-white/5 text-[#8b92a0] border-white/10";
        return /*#__PURE__*/React.createElement("div", {
          className: "mt-2"
        }, /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-[#8b92a0]"
        }, "Move:"), /*#__PURE__*/React.createElement("span", {
          className: `px-2 py-0.5 rounded border font-semibold ${pill}`
        }, icon, " ", status, severity ? /*#__PURE__*/React.createElement("span", {
          className: "ml-1 text-[10px] opacity-80"
        }, "(", severity, ")") : null), kanbanStage ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Action:"), /*#__PURE__*/React.createElement("span", {
          className: `px-2 py-0.5 rounded border font-semibold ${kanbanPill}`
        }, kanbanStage)) : null), /*#__PURE__*/React.createElement("div", {
          className: "mt-1 text-[10px] text-[#5c6475]"
        }, /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${freshnessCls}`
        }, freshnessLabel), (status === "INVALIDATED" || status === "COMPLETED") && headlineReason ? /*#__PURE__*/React.createElement("span", null, " ", "\u2022", " ", /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, status === "INVALIDATED" ? "Invalidated" : "Completed", ":"), " ", /*#__PURE__*/React.createElement("span", {
          className: "text-[#f0f2f5]"
        }, headlineReason)) : null, status === "ACTIVE" && headlineReason && severity && severity !== "NONE" ? /*#__PURE__*/React.createElement("span", null, " ", "\u2022 ", /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Reason:"), " ", /*#__PURE__*/React.createElement("span", {
          className: "text-[#f0f2f5]"
        }, headlineReason)) : null), status === "INVALIDATED" && reasons.length > 0 ? /*#__PURE__*/React.createElement("div", {
          className: "mt-1 flex flex-wrap gap-1.5"
        }, reasons.map((r, idx) => /*#__PURE__*/React.createElement("span", {
          key: `inv-reason-${idx}`,
          className: "px-2 py-0.5 rounded border border-red-500/20 bg-red-500/10 text-[10px] text-red-200"
        }, pretty(r)))) : null, status === "COMPLETED" && reasons.length > 0 ? /*#__PURE__*/React.createElement("div", {
          className: "mt-1 flex flex-wrap gap-1.5"
        }, reasons.map((r, idx) => /*#__PURE__*/React.createElement("span", {
          key: `comp-reason-${idx}`,
        ...
        return /*#__PURE__*/React.createElement("button", {
          ...
          className: `px-3 py-1 rounded-lg border text-[11px] font-semibold transition-all ${active ? "border-blue-400 bg-blue-500/20 text-blue-200" : "border-[#252b36] bg-[#1a1f28] text-[#8b92a0] hover:text-white"}`
        }, t.label);
      }))), /*#__PURE__*/React.createElement("div", {
        className: "p-6 pt-4"
        ...
        return /*#__PURE__*/React.createElement("div", {
          className: "mb-4 p-3 bg-[#1a1f28] border-2 border-[#252b36] rounded-lg"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-sm text-[#8b92a0] mb-2"
        }, "Context"), latestTickerLoading ? /*#__PURE__*/React.createElement("div", {
          className: "text-xs text-[#5c6475]"
          ...
          className: "mt-1 text-xs text-[#8b92a0] leading-snug"
        }, description) : null, /*#__PURE__*/React.createElement("div", {
          className: "mt-1 text-[11px] text-[#8b92a0]"
        }, [sector, industry, country].filter(Boolean).join(" • ") || "—"), trStatus || trValue != null || lastEarnTs || events?.next_earnings_ts ? /*#__PURE__*/React.createElement("div", {
          className: "mt-2 grid grid-cols-2 gap-2 text-[10px]"
        }, trStatus || trValue != null ? /*#__PURE__*/React.createElement("div", {
          className: "p-2 bg-[#13171e] border border-[#252b36] rounded"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-[9px] text-[#8b92a0] mb-1",
        ...
        const tickerSectorRaw = getTickerSector(ticker.ticker) || ticker.sector || ticker.fundamentals?.sector || "";
        ...
        if (sectorKey && sectors.length > 0) {
          ...
          const displaySector = sectorInfo?.sector || sectorInfo?.name || sectorKeyToCanonicalName(sectorKey);
          const rating = String(sectorInfo?.rating || "neutral").toLowerCase();
          const boost = sectorInfo?.boost != null ? Number(sectorInfo.boost) : null;
          ...
          }, displaySector), /*#__PURE__*/React.createElement("span", {
            className: `text-[10px] px-2 py-0.5 rounded ${rating === "overweight" ? "bg-green-500/20 text-green-400" : rating === "underweight" ? "bg-red-500/20 text-red-400" : "bg-[#252b36] text-[#8b92a0]"}`
          }, rating.charAt(0).toUpperCase() + rating.slice(1)), Number.isFinite(boost) && boost !== 0 && /*#__PURE__*/React.createElement("span", {
        ...
        className: "text-sm text-[#8b92a0] font-semibold"
      }, "System Guidance"), decisionSummary && /*#__PURE__*/React.createElement("span", {
        className: `px-2 py-0.5 rounded text-[10px] font-semibold ${decisionSummary.bg} ${decisionSummary.tone}`
      }, decisionSummary.status)), /*#__PURE__*/React.createElement("div", {
        ...
        }, Number.isFinite(sl) && /*#__PURE__*/React.createElement("div", {
          className: "p-2 bg-red-500/10 border border-red-500/30 rounded"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-red-300 mb-0.5"
        }, "Stop Loss"), /*#__PURE__*/React.createElement("div", {
          className: "font-semibold text-red-400"
        }, "$", sl.toFixed(2))), Number.isFinite(tpTarget) && /*#__PURE__*/React.createElement("div", {
          className: "p-2 bg-green-500/10 border border-green-500/30 rounded"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-green-300 mb-0.5"
        }, "Target Price"), /*#__PURE__*/React.createElement("div", {
          className: "font-semibold text-green-400"
        }, "$", tpTarget.toFixed(2))), Number.isFinite(tpMax) && Math.abs(tpMax - (tpTarget || 0)) > 0.01 && /*#__PURE__*/React.createElement("div", {
          className: "p-2 bg-green-500/10 border border-green-500/30 rounded"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-green-300 mb-0.5"
        }, "Stretch Goal"), /*#__PURE__*/React.createElement("div", {
          className: "font-semibold text-green-400"
        }, "$", tpMax.toFixed(2))), Number.isFinite(rr) && /*#__PURE__*/React.createElement("div", {
          className: "p-2 bg-blue-500/10 border border-blue-500/30 rounded"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-[10px] text-blue-300 mb-0.5"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-xs text-[#8b92a0] mb-2 font-semibold"
        ...
        className: "flex justify-between items-center py-1 border-b border-[#252b36]/50"
      }, /*#__PURE__*/React.createElement("span", {
        className: "text-[#8b92a0]"
        ...
        className: "ml-2 text-[10px] text-[#8b92a0] font-normal"
      }, "(as of ", rankAsOfText, ")"))), (() => {
        ...
        const hasMomentumData = mp.week != null || mp.month != null || mp.three_months != null || mp.six_months != null;
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-[9px] px-1.5 py-0.5 rounded border bg-purple-500/20 border-purple-500/40 text-purple-200"
        }, "ACTIVE")), /*#__PURE__*/React.createElement("div", {
          className: "grid grid-cols-2 gap-1.5 text-[9px]"
        }, Number.isFinite(w) && /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "1W:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${okW ? 'text-green-400' : 'text-[#8b92a0]'}`
        }, w.toFixed(1), "%")), Number.isFinite(m) && /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "1M:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${okM ? 'text-green-400' : 'text-[#8b92a0]'}`
        }, m.toFixed(1), "%")), Number.isFinite(m3) && /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "3M:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${ok3 ? 'text-green-400' : 'text-[#8b92a0]'}`
        }, m3.toFixed(1), "%")), Number.isFinite(m6) && /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "6M:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${ok6 ? 'text-green-400' : 'text-[#8b92a0]'}`
        }, m6.toFixed(1), "%"))));
      })(), (() => {
        ...
        return breakdownComponents.length > 0 ? /*#__PURE__*/React.createElement("div", {
          ...
          className: "flex justify-between items-center text-sm mt-2 pt-2 border-t border-[#252b36]"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0] font-semibold"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-xs text-[#8b92a0] font-semibold"
        }, "\uD83D\uDE80 Momentum Elite"), /*#__PURE__*/React.createElement("span", {
          className: "text-[10px] px-2 py-0.5 rounded border bg-purple-500/20 border-purple-500/40 text-purple-200"
        }, "ACTIVE")), /*#__PURE__*/React.createElement("div", {
        ...
        const tpPrices = tpLevels.map(tpItem => {
          ...
          return {
            price: typeof tpItem === "number" ? Number(tpItem) : Number(tpItem),
            source: "ATR Level",
            type: "ATR_FIB",
            timeframe: "D",
            label: "TP"
        ...
        const direction = ticker.state?.includes("BULL") ? "LONG" : ticker.state?.includes("BEAR") ? "SHORT" : null;
        const isLong = direction === "LONG";
        tpPrices.sort((a, b) => isLong ? a.price - b.price : b.price - a.price);
        return /*#__PURE__*/React.createElement("div", {
          className: "border-t border-[#252b36] my-3 pt-3"
        }, /*#__PURE__*/React.createElement("button", {
          onClick: () => setTpExpanded(!tpExpanded),
          className: "w-full flex items-center justify-between text-xs text-[#8b92a0] mb-2 font-semibold hover:text-white transition-colors"
        }, /*#__PURE__*/React.createElement("span", null, "TP Levels (", tpPrices.length, ")"), /*#__PURE__*/React.createElement("span", {
          className: "text-base"
        ...
        return /*#__PURE__*/React.createElement("button", {
          ...
          className: `px-2 py-1 rounded border text-[11px] font-semibold transition-all ${active ? "border-blue-400 bg-blue-500/20 text-blue-200" : "border-[#252b36] bg-[#13171e] text-[#8b92a0] hover:text-white"}`,
        ...
        try {
          ...
          return /*#__PURE__*/React.createElement("div", {
          ...
          })()) : null)), crosshair && crosshair.candle ? /*#__PURE__*/React.createElement("div", {
            ...
            className: "mt-2 text-[10px] text-[#8b92a0] flex items-center justify-between"
          }, /*#__PURE__*/React.createElement("span", null, String(chartTf) === "D" ? "Daily" : String(chartTf) === "W" ? "Weekly" : `${chartTf}m`, " ", "\u2022 ", candles.length, " bars"), /*#__PURE__*/React.createElement("span", {
            className: "font-mono"
        ...
        className: "mt-6 pt-6 border-t-2 border-[#252b36]"
      }, /*#__PURE__*/React.createElement("div", {
        className: "text-sm font-bold text-[#8b92a0] mb-4"
      }, "\u26A1 Triggers"), /*#__PURE__*/React.createElement("div", {
        className: "p-3 bg-[#1a1f28] rounded-lg border border-[#252b36]"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-xs text-[#8b92a0] flex items-center gap-2"
        }, /*#__PURE__*/React.createElement("span", null, sqIcons), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${sig === 1 ? "text-green-400" : sig === -1 ? "text-red-400" : "text-[#8b92a0]"}`
        }, sigLabel))), /*#__PURE__*/React.createElement("div", {
          className: "grid grid-cols-2 gap-3"
        }, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
          className: "text-[11px] text-[#8b92a0] mb-1"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "mb-4 p-3 bg-[#1a1f28] rounded-lg border border-[#252b36]"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-xs text-[#8b92a0] mb-2"
          ...
          className: `font-semibold ${Number(tdSeq.bullish_prep_count || 0) >= 6 ? "text-yellow-400" : Number(tdSeq.bullish_prep_count || 0) >= 3 ? "text-green-400" : "text-[#8b92a0]"}`
        }, tdSeq.bullish_prep_count || 0, "/9")), /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Bearish Prep:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${Number(tdSeq.bearish_prep_count || 0) >= 6 ? "text-yellow-400" : Number(tdSeq.bearish_prep_count || 0) >= 3 ? "text-red-400" : "text-[#8b92a0]"}`
        }, tdSeq.bearish_prep_count || 0, "/9")), /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Bullish Leadup:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${Number(tdSeq.bullish_leadup_count || 0) >= 6 ? "text-yellow-400" : Number(tdSeq.bullish_leadup_count || 0) >= 3 ? "text-green-400" : "text-[#8b92a0]"}`
        }, tdSeq.bullish_leadup_count || 0, "/13")), /*#__PURE__*/React.createElement("div", {
          className: "flex justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Bearish Leadup:"), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${Number(tdSeq.bearish_leadup_count || 0) >= 6 ? "text-yellow-400" : Number(tdSeq.bearish_leadup_count || 0) >= 3 ? "text-red-400" : "text-[#8b92a0]"}`
          ...
          className: "text-xs text-[#8b92a0] mt-1"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "mt-2 h-2 bg-[#252b36] rounded-full overflow-hidden"
        }, /*#__PURE__*/React.createElement("div", {
          ...
          className: "flex justify-between text-[10px] text-[#8b92a0] mt-1"
        ...
        className: "mt-3 pt-3 border-t border-[#252b36]"
      }, /*#__PURE__*/React.createElement("div", {
        ...
        className: "text-[10px] text-[#8b92a0] mt-0.5"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "mb-3 p-3 bg-[#1a1f28] rounded-lg border border-[#252b36]"
        }, /*#__PURE__*/React.createElement("div", {
          className: "text-xs text-[#8b92a0] mb-2 font-semibold"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: "text-[10px] text-[#8b92a0] mb-1"
          ...
          className: `font-semibold ${fund.peg_ratio < 0.8 ? "text-green-400" : fund.peg_ratio < 1.0 ? "text-yellow-400" : fund.peg_ratio > 1.5 ? "text-red-400" : "text-[#8b92a0]"}`
          ...
          className: `font-semibold ${fund.eps_growth_rate > 20 ? "text-green-400" : fund.eps_growth_rate > 10 ? "text-yellow-400" : fund.eps_growth_rate > 0 ? "text-[#8b92a0]" : "text-red-400"}`
          ...
          className: `font-semibold ${fund.premium_discount_pct < -10 ? "text-green-400" : fund.premium_discount_pct < 0 ? "text-yellow-400" : fund.premium_discount_pct > 10 ? "text-red-400" : "text-[#8b92a0]"}`
          ...
          className: "mt-2 pt-2 border-t border-[#252b36] text-xs text-[#8b92a0]"
          ...
          className: "flex justify-between col-span-2 pt-1 border-t border-[#252b36]"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
          ...
          className: "mt-2 pt-2 border-t border-[#252b36] text-xs"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Current Position:", " "), /*#__PURE__*/React.createElement("span", {
          className: `font-semibold ${fund.pe_percentile_position.includes("Bottom") ? "text-green-400" : fund.pe_percentile_position.includes("Top") ? "text-red-400" : "text-[#8b92a0]"}`
          ...
          className: "text-xs text-[#8b92a0] mb-1"
      ...
      })()) : null, railTab === "CHART" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
        className: "mb-4 p-3 bg-[#1a1f28] border-2 border-[#252b36] rounded-lg"
      }, /*#__PURE__*/React.createElement("div", {
        className: "flex items-center justify-between gap-2 mb-3"
      }, /*#__PURE__*/React.createElement("div", {
        ...
        try {
          ...
          if (n < 2) {
            return /*#__PURE__*/React.createElement("div", {
              className: "text-xs text-[#8b92a0]"
            }, "Candle data loaded, but it\u2019s not in the expected OHLC format yet. (Waiting for valid captures.)");
          }
          const lows = candles.map(c => Number(c.l));
          const highs = candles.map(c => Number(c.h));
          let minL = Math.min(...lows);
        ...
        className: "text-sm text-[#8b92a0]"
      }, "Trade Journey"), /*#__PURE__*/React.createElement("a", {
        ...
        const stage = String(ticker?.kanban_stage || "").trim();
        if (!stage) return null;
        const up = stage.toLowerCase();
        const label = up.replaceAll("_", " ").toUpperCase();
        const cls = up === "exit" ? "bg-red-500/15 text-red-300 border-red-500/40" : up === "trim" ? "bg-yellow-500/15 text-yellow-300 border-yellow-500/40" : up === "defend" ? "bg-orange-500/15 text-orange-300 border-orange-500/40" : up === "hold" ? "bg-blue-500/15 text-blue-300 border-blue-500/40" : up === "enter_now" ? "bg-green-500/15 text-green-300 border-green-500/40" : "bg-white/5 text-[#8b92a0] border-white/10";
        return /*#__PURE__*/React.createElement("div", {
          className: "mb-2 text-[11px] flex items-center gap-2"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Now:"), /*#__PURE__*/React.createElement("span", {
          className: `px-2 py-0.5 rounded border font-semibold ${cls}`
        }, label), /*#__PURE__*/React.createElement("span", {
          className: "text-[#5c6475]"
        }, "(ledger may still show an open trade while we are in an exit lane)"));
      })(), ledgerTradesLoading ? /*#__PURE__*/React.createElement("div", {
        className: "text-xs text-[#8b92a0] flex items-center gap-2"
      }, /*#__PURE__*/React.createElement("div", {
        className: "loading-spinner"
      }), "Loading ledger trades\u2026") : ledgerTradesError ? /*#__PURE__*/React.createElement("div", {
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          className: `px-2 py-0.5 rounded text-[10px] font-semibold ${t.status === "WIN" ? "bg-green-500/20 text-green-400 border border-green-500/30" : "bg-red-500/20 text-red-400 border border-red-500/30"}`
          ...
          className: "text-white font-semibold"
        }, formatDateTime(t.entry_ts))), /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Entry Price:"), /*#__PURE__*/React.createElement("span", {
          className: "text-green-400 font-semibold"
        }, "$", entryPrice > 0 ? entryPrice.toFixed(2) : "—")), quantity > 0 && /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
          ...
          className: "text-[#8b92a0]"
        }, "Exited:"), /*#__PURE__*/React.createElement("span", {
          className: "text-white font-semibold"
        }, formatDateTime(t.exit_ts))), /*#__PURE__*/React.createElement("div", {
          className: "flex items-center justify-between"
        }, /*#__PURE__*/React.createElement("span", {
          className: "text-[#8b92a0]"
        }, "Exit Price:"), /*#__PURE__*/React.createElement("span", {
          className: "text-red-400 font-semibold"
        }, "$", exitPrice > 0 ? exitPrice.toFixed(2) : "—")))));
      }), ledgerTrades.length > 5 && /*#__PURE__*/React.createElement("div", {
        className: "text-[10px] text-[#5c6475] text-center"
      }, "Showing 5 of ", ledgerTrades.length, " recent trades")))) : null, railTab === "JOURNEY" ? /*#__PURE__*/React.createElement(React.Fragment, null, (() => {
        ...
        const calculatePerformance = daysBack => {
          ...
          if (Array.isArray(bubbleJourney) && bubbleJourney.length > 0) {
            ...
            const validPoints = bubbleJourney.map(p => ({
              ts: Number(p.__ts_ms || p.ts),
              price: Number(p.price)
            })).filter(p => Number.isFinite(p.ts) && Number.isFinite(p.price) && p.price > 0).sort((a, b) => a.ts - b.ts); // Ascending: oldest first
        ...
        if (performanceData.length === 0) {
          return /*#__PURE__*/React.createElement("div", {
            className: "mb-4 p-3 bg-[#1a1f28] border border-[#252b36] rounded-lg text-xs text-[#8b92a0]"
        ...
        return /*#__PURE__*/React.createElement("div", {
          ...
          return /*#__PURE__*/React.createElement("div", {
            ...
            className: "text-xs font-bold text-[#8b92a0]"
          }, label), /*#__PURE__*/React.createElement("div", {
            ...
            className: "text-xs text-[#cbd5ff] leading-relaxed bg-[#13171e] p-2 rounded border border-[#252b36]/50"
          }, getInterpretation()));
        }));
      })(), /*#__PURE__*/React.createElement("div", {
        className: "mb-4 p-3 bg-[#1a1f28] border-2 border-[#252b36] rounded-lg"
      ...
      }, downsampleByInterval(bubbleJourney, 15 * 60 * 1000).slice().reverse().slice(0, 40).map((p, idx) => {
        ...
        return /*#__PURE__*/React.createElement("div", {
          key: `${ts}-${idx}`,
          className: `px-2 py-1 bg-[#13171e] border rounded flex items-center justify-between gap-2 cursor-pointer transition-colors ${isSelected ? "border-cyan-400/80 bg-cyan-500/10" : "border-[#252b36] hover:border-cyan-400/40 hover:bg-[#16224a]"}`,
          onMouseEnter: () => {
          ...
          className: "text-right text-[10px] text-[#8b92a0] whitespace-nowrap"
        ...
        className: "mb-4 p-3 bg-[#1a1f28] border border-[#252b36] rounded-lg"
      }, /*#__PURE__*/React.createElement("div", {
        className: "text-xs text-[#8b92a0] mb-2 font-semibold"
        ...
        className: "flex-shrink-0 p-6 pt-4 border-t border-[#252b36] bg-[#13171e]"
